...
const routes = [
    ...
    { path: 'folder/:id', loadChildren: () => __webpack_require__.e(/*! import() | folder-folder-module */ "folder-folder-module").then(__webpack_require__.bind(null, /*! ./folder/folder.module */ "./src/app/folder/folder.module.ts")).then(m => m.FolderPageModule) },
    ...
    { path: 'about/:id', loadChildren: () => __webpack_require__.e(/*! import() | about-about-module */ "about-about-module").then(__webpack_require__.bind(null, /*! ./about/about.module */ "./src/app/about/about.module.ts")).then(m => m.AboutPageModule) },
    { path: 'blog', loadChildren: () => __webpack_require__.e(/*! import() | blog-blog-module */ "blog-blog-module").then(__webpack_require__.bind(null, /*! ./blog/blog.module */ "./src/app/blog/blog.module.ts")).then(m => m.BlogPageModule) },
    { path: 'contact', loadChildren: () => __webpack_require__.e(/*! import() | contact-contact-module */ "contact-contact-module").then(__webpack_require__.bind(null, /*! ./contact/contact.module */ "./src/app/contact/contact.module.ts")).then(m => m.ContactPageModule) },
    { path: 'blog-detail', loadChildren: () => __webpack_require__.e(/*! import() | blog-detail-blog-detail-module */ "blog-detail-blog-detail-module").then(__webpack_require__.bind(null, /*! ./blog-detail/blog-detail.module */ "./src/app/blog-detail/blog-detail.module.ts")).then(m => m.BlogDetailPageModule) },
    ...
    { path: 'resources', loadChildren: () => __webpack_require__.e(/*! import() | resources-resources-module */ "resources-resources-module").then(__webpack_require__.bind(null, /*! ./resources/resources.module */ "./src/app/resources/resources.module.ts")).then(m => m.ResourcesPageModule) },
    {
        path: 'resource-detail',
        loadChildren: () => __webpack_require__.e(/*! import() | resource-detail-resource-detail-module */ "resource-detail-resource-detail-module").then(__webpack_require__.bind(null, /*! ./resource-detail/resource-detail.module */ "./src/app/resource-detail/resource-detail.module.ts")).then(m => m.ResourceDetailPageModule)
    },
    {
        path: 'memory-verses',
        loadChildren: () => __webpack_require__.e(/*! import() | memory-verses-memory-verses-module */ "memory-verses-memory-verses-module").then(__webpack_require__.bind(null, /*! ./memory-verses/memory-verses.module */ "./src/app/memory-verses/memory-verses.module.ts")).then(m => m.MemoryVersesPageModule)
    },
    {
        path: 'leader-notes',
        loadChildren: () => __webpack_require__.e(/*! import() | leader-notes-leader-notes-module */ "leader-notes-leader-notes-module").then(__webpack_require__.bind(null, /*! ./leader-notes/leader-notes.module */ "./src/app/leader-notes/leader-notes.module.ts")).then(m => m.LeaderNotesPageModule)
    },
    {
        path: 'resource-single-content',
        loadChildren: () => __webpack_require__.e(/*! import() | resource-single-content-resource-single-content-module */ "resource-single-content-resource-single-content-module").then(__webpack_require__.bind(null, /*! ./resource-single-content/resource-single-content.module */ "./src/app/resource-single-content/resource-single-content.module.ts")).then(m => m.ResourceSingleContentPageModule)
    },
    {
        path: 'login',
    ...
    {
        path: 'staff',
        loadChildren: () => __webpack_require__.e(/*! import() | staff-staff-module */ "staff-staff-module").then(__webpack_require__.bind(null, /*! ./staff/staff.module */ "./src/app/staff/staff.module.ts")).then(m => m.StaffPageModule)
    },
    {
        path: 'directors',
        loadChildren: () => __webpack_require__.e(/*! import() | directors-directors-module */ "directors-directors-module").then(__webpack_require__.bind(null, /*! ./directors/directors.module */ "./src/app/directors/directors.module.ts")).then(m => m.DirectorsPageModule)
    },
    {
        path: 'speaking',
        loadChildren: () => __webpack_require__.e(/*! import() | speaking-speaking-module */ "speaking-speaking-module").then(__webpack_require__.bind(null, /*! ./speaking/speaking.module */ "./src/app/speaking/speaking.module.ts")).then(m => m.SpeakingPageModule)
    },
    {
        path: 'register',
    ...
    {
        path: 'privacypolicy',
        loadChildren: () => __webpack_require__.e(/*! import() | privacypolicy-privacypolicy-module */ "privacypolicy-privacypolicy-module").then(__webpack_require__.bind(null, /*! ./privacypolicy/privacypolicy.module */ "./src/app/privacypolicy/privacypolicy.module.ts")).then(m => m.PrivacypolicyPageModule)
    }
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, Router, LoadingController, theInAppBrowser) {
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        entryComponents: [],
        imports: [
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"],
        ...
        providers: [
            ...
            _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_10__["InAppBrowser"], _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_11__["LocalNotifications"], _ionic_native_barcode_scanner_ngx__WEBPACK_IMPORTED_MODULE_12__["BarcodeScanner"],
...
module.exports = __webpack_require__(/*! C:\discipleFirst\src\main.ts */"./src/main.ts");
